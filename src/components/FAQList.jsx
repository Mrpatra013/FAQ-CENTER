...
const FAQList = ({ toggleDarkMode, darkMode }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm-px-6 lg:px-8 py-12">
      ...
      <div className="bg-white/80 dark:bg-gray-800/80 rounded-xl shadow-lg border border-gray-100/50 dark:border-indigo-900/30 overflow-hidden transition-all duration-300">
        {faqData.map((item) => (
          <FAQItems
            key={item.id}
            item={item}
